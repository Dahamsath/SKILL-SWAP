...
if ($_POST && isset($_POST['grade_assignment'])) {
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
        ...
        .course-title { color: #7f8c8d; font-size: 0.9rem; margin-bottom: 0.5rem; }
        .assignment-title { color: #3498db; font-weight: bold; margin-bottom: 0.5rem; }
        .submission-date { color: #95a5a6; font-size: 0.85rem; }
        .file-link { 
            display: inline-flex; 
            align-items: center; 
            color: #3498db; 
        ...
        .grade-form { margin-top: 1.5rem; padding-top: 1.5rem; border-top: 1px solid #eee; }
...
<body>
    ...
    <nav class="navbar" id="navbar">
        ...
        <div class="navbar-links" id="navbarLinks">
            <span class="user-greeting">Hey, <?= htmlspecialchars($_SESSION['name'] ?? 'Admin') ?>!</span>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="tabs">
                <button class="tab active" data-tab="pending">Pending Submissions (<?= count($pending_submissions) ?>)</button>
                <button class="tab" data-tab="graded">Graded Assignments (<?= count($graded_submissions) ?>)</button>
            </div>
                            ...
                            <div class="grade-form">
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="points_<?= $submission['submission_id'] ?>">Points Awarded (out of <?= $submission['max_points'] ?>)</label>
                                        <input type="number" 
                                            id="points_<?= $submission['submission_id'] ?>" 
                                            name="points" 
                                            min="0" 
                        ...
                        <div class="submission-card">
                            ...
                            <div style="margin-top: 1rem;">
                                ...
                                <?php if (!empty($submission['feedback'])): ?>
                                    <div style="margin-top: 0.5rem;"><strong>Feedback:</strong> <?= nl2br(htmlspecialchars($submission['feedback'])) ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endforeach; ?>
